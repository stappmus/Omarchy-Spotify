...
qmllint -I /usr/share/omarchy/shell Api.js OAuth.js AuthManager.qml \
  ...
  ArtistSearchSection.qml LyricsClient.qml LyricsView.qml ArtworkClient.qml ArtworkZoom.qml \
  ShortcutHint.qml TransportButton.qml Panel.qml FastScrollHandler.qml
